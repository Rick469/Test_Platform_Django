...
class Test_20190815113713get_product_pool_list (unittest.TestCase):
    ...
    def test_get_product_pool_list(self):
        ...
        data_type = 'JSON'
        params = {
    "token": "22f2e80f-b470-4e40-aa21-914e25defb47"
}
        headers = ''
        depende_flag = 1
        get_response_param = ''
...
if __name__ == '__main__':
    cases = unittest.defaultTestLoader.discover(r'C:\Users\rick_zhang\Desktop\Test_Platform\sign/API_Test/api_test_case/', pattern='20190815113713get_product_pool_list.py')
    result = BeautifulReport(cases).report(filename='Report-20190815113713get_product_pool_list.html', description='API-AutoTest-Report', log_path=r'C:\Users\rick_zhang\Desktop\Test_Platform\sign//static/api_test_file/api_test_report/')
