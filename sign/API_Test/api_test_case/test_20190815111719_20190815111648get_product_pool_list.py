...
class Test_20190815111648get_product_pool_list (unittest.TestCase):
    ...
    def test_get_product_pool_list(self):
        """get_product_pool_list"""
        url = 'http://SP-staging.ehsy.com/guodianmall/getPageNum'
        project = 'SP'
        method = 'POST'
        data_type = 'JSON'
        params = {
    "token": "9df1187b-4c23-42be-baab-c7c46bfb43a2"
}
        headers = ''
        depende_flag = 1
        get_response_param = ''
...
if __name__ == '__main__':
    cases = unittest.defaultTestLoader.discover(r'C:\Users\rick_zhang\Desktop\Test_Platform\sign/API_Test/api_test_case/', pattern='20190815111648get_product_pool_list.py')
    result = BeautifulReport(cases).report(filename='Report-20190815111648get_product_pool_list.html', description='API-AutoTest-Report', log_path=r'C:\Users\rick_zhang\Desktop\Test_Platform\sign//static/api_test_file/api_test_report/')
